...
core_start_sector equ 0x00000001    ;常数，内核的起始逻辑扇区号
    ...
    ;建立保护模式下的显示缓冲区描述符
    mov dword [ebx + 0x20], 0x80007fff      ;基地址为0x000b8000,界限为0x07fff
...
;构造描述符
;输入：EAX=线性基地址，EBX=段界限，ECX=属性（各属性都在原始位置，其他没用到的位置0）
;返回：EDX:EAX=完整的描述符
make_gdt_descriptor:
    mov edx, eax
    shl eax, 16
    ...
    rol edx, 8
    bswap edx               ;装配基址的24～31和16～23（80486+）
